...
"[project]/Downloads/wedding/wedding/server/src/app/api/vendors/[id]/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const GET = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$wedding$2f$wedding$2f$server$2f$src$2f$lib$2f$cors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withCORS"])(async (_request, context)=>{
    try {
        ...
        const vendor = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$wedding$2f$wedding$2f$server$2f$src$2f$models$2f$Vendor$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(id).select('-passwordHash').lean();
        if (!vendor) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$wedding$2f$wedding$2f$server$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
...
const PUT = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$wedding$2f$wedding$2f$server$2f$src$2f$lib$2f$cors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withCORS"])(async (request, { params })=>{
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$wedding$2f$wedding$2f$server$2f$src$2f$lib$2f$db$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
        const { id } = params;
        if (!id) {
        ...
        const vendor = await __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$wedding$2f$wedding$2f$server$2f$src$2f$models$2f$Vendor$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findByIdAndUpdate(id, update, {
            new: true
        });
        if (!vendor) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$wedding$2f$wedding$2f$server$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__56f4199c._.js.map