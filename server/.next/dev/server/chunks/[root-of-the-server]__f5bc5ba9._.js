...
"[project]/server/src/app/api/vendors/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const GET = (0, __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$src$2f$lib$2f$cors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withCORS"])(async (request)=>{
    try {
        ...
        const allVendors = await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$src$2f$models$2f$Vendor$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({}).select('-passwordHash').sort({
            createdAt: -1
        }).lean();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f5bc5ba9._.js.map