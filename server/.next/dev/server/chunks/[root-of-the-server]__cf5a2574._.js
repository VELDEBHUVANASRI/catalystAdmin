...
"[project]/server/src/models/Event.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/server/src/models/Subscription.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/server/src/app/api/analytics/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$src$2f$models$2f$Event$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/server/src/models/Event.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$src$2f$models$2f$Subscription$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/server/src/models/Subscription.js [app-route] (ecmascript)");
...
const GET = (0, __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$src$2f$lib$2f$cors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withCORS"])(async (request)=>{
    try {
        ...
        // Get user stats
        const totalUsers = await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$src$2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments();
        const activeUsers = await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$src$2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments({
            status: 'active'
        });
        const blockedUsers = await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$src$2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments({
            status: 'blocked'
        });
        // Get vendor stats
        const totalVendors = await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$src$2f$models$2f$Vendor$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments();
        const activeVendors = await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$src$2f$models$2f$Vendor$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments({
            status: 'approved'
        });
        const blockedVendors = await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$src$2f$models$2f$Vendor$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments({
            status: 'rejected'
        });
        // Get service stats
        const totalServices = await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$src$2f$models$2f$Service$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments();
        const acceptedServices = await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$src$2f$models$2f$Service$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments({
            status: 'accepted'
        });
        // Get event stats
        const totalEvents = await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$src$2f$models$2f$Event$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments();
        const eventTypeAggregation = await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$src$2f$models$2f$Event$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].aggregate([
            {
                $group: {
                    _id: '$eventType',
                    count: {
        ...
        const userRegistrations = await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$src$2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].aggregate([
            {
                $match: {
                    createdAt: {
                        $gte: sixMonthsAgo
        ...
        const vendorRegistrations = await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$src$2f$models$2f$Vendor$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].aggregate([
            {
                $match: {
                    createdAt: {
                        $gte: sixMonthsAgo
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cf5a2574._.js.map