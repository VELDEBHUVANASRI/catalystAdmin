...
"[project]/server/src/models/UserTicket.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/mongoose [external] (mongoose, cjs)");
;
const UserTicketSchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].Schema({
    ticketId: {
        type: String,
        unique: true,
        trim: true
...
UserTicketSchema.pre('save', async function(next) {
    if (!this.ticketId) {
        const count = await __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].model('UserTicket').countDocuments();
        this.ticketId = `UTK-${String(count + 1).padStart(3, '0')}`;
    }
    next();
});
const __TURBOPACK__default__export__ = __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].models.UserTicket || __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].model('UserTicket', UserTicketSchema);
}),
...
"[project]/server/src/app/api/usertickets/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$src$2f$models$2f$UserTicket$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/server/src/models/UserTicket.js [app-route] (ecmascript)");
...
const GET = (0, __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$src$2f$lib$2f$cors$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withCORS"])(async (request)=>{
    try {
        ...
        const tickets = await __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$src$2f$models$2f$UserTicket$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find(filters).populate('userId', 'name email').populate('vendorId', 'businessName').sort({
            createdAt: -1
        }).lean();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5bd15481._.js.map